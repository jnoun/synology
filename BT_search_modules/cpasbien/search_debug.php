...
//
//$rCurlResource = curl_init();
//$oPlugin = new SynoDLMSearchCpasbien();
//$oPlugin->prepare($rCurlResource, 'edge of tomorrow');
//curl_setopt($rCurlResource, CURLOPT_RETURNTRANSFER, true);
//$sHTML = curl_exec($rCurlResource);
//
//var_dump($sHTML);
//
//$oPlugin->parse('dunny', $sHTML);
//
//
//curl_close($rCurlResource);
